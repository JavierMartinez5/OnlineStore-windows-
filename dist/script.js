...
/* harmony import */ var _modules_modalsDataListener__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modalsDataListener */ "./src/js/modules/modalsDataListener.js");
/* harmony import */ var _modules_saleTimer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/saleTimer */ "./src/js/modules/saleTimer.js");
/* harmony import */ var _modules_imgGallery__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/imgGallery */ "./src/js/modules/imgGallery.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_modalsDataListener__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".no_click", ".decoration_content > .row > div", "after_click");
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".glazing_block", ".glazing_content");
  ...
  Object(_modules_saleTimer__WEBPACK_IMPORTED_MODULE_5__["default"])("December 30, 2020 02:52:00", ".timer1");
  Object(_modules_imgGallery__WEBPACK_IMPORTED_MODULE_6__["default"])();
});

/***/ }),

/***/ "./src/js/modules/clearHelper.js":
/*!***************************************!*\
  !*** ./src/js/modules/clearHelper.js ***!
  \***************************************/
...
var clearHelper = {
  clearDataOnModals: function clearDataOnModals() {
    var allInputsInModal = document.body.querySelectorAll(".popup_dialog input");
    allInputsInModal.forEach(function (input) {
    ...
    var balconIcons = document.body.querySelectorAll(".balcon_icons_img");
    balconIcons.forEach(function (icon) {
      icon.classList.remove("do_image_more");
    });
    balconIcons[0].classList.add("do_image_more");
  },
  clearModalsDataStore: function clearModalsDataStore(DataStore) {
...
/* harmony default export */ __webpack_exports__["default"] = (clearHelper);
...
/* harmony import */ var _modalsDataStore__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modalsDataStore */ "./src/js/modules/modalsDataStore.js");
/* harmony import */ var _clearHelper__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./clearHelper */ "./src/js/modules/clearHelper.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  function formHandler(form) {
    ...
    if (form.getAttribute("data-calc") === "formWithDataFromPreviousModals") {
      Object.entries(_modalsDataStore__WEBPACK_IMPORTED_MODULE_14__["default"]).forEach(function (_ref) {
    ...
    postRequest(formData).then(function (res) {
      console.log(res);
      ...
      form.reset();
      _clearHelper__WEBPACK_IMPORTED_MODULE_15__["default"].clearModalsDataStore(_modalsDataStore__WEBPACK_IMPORTED_MODULE_14__["default"]);
    });
  }
    ...
    return regeneratorRuntime.async(function postRequest$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(fetch("assets/server.php", {
              method: "POST",
              body: data
            }));
  ...
  function showRequestProcessMessage(msg, msgColor, container) {
    var timeOut = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    var msgBlock = container.querySelector(".status");
  ...
  function setPatternForPhoneInput(form) {
    var phoneInput = form.elements["user_phone"];
    if (!phoneInput) return;
    phoneInput.addEventListener("input", function () {
      phoneInput.value = phoneInput.value.replace(/[^0-9+]/, "");
    });
    phoneInput.setAttribute("pattern", "[+0-9|0-9]{10,13}"); // phoneInput.setAttribute("type", "tel");
...
__webpack_require__.r(__webpack_exports__);
var customIcons = {
  arrowRigth: "<svg width=\"4em\" height=\"4em\" viewBox=\"0 0 16 16\" class=\"bi bi-arrow-right-circle\" fill=\"currentColor\" xmlns=\"http://www.w3.org/2000/svg\">\n    <path fill-rule=\"evenodd\" d=\"M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z\"/>\n    <path fill-rule=\"evenodd\" d=\"M4 8a.5.5 0 0 0 .5.5h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5A.5.5 0 0 0 4 8z\"/>\n    </svg>",
  arrowLeft: "<svg width=\"4em\" height=\"4em\" viewBox=\"0 0 16 16\" class=\"bi bi-arrow-left-circle\" fill=\"currentColor\" xmlns=\"http://www.w3.org/2000/svg\">\n    <path fill-rule=\"evenodd\" d=\"M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z\"/>\n    <path fill-rule=\"evenodd\" d=\"M12 8a.5.5 0 0 1-.5.5H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5a.5.5 0 0 1 .5.5z\"/>\n    </svg>"
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return galleryInit; });
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./icons */ "./src/js/modules/icons.js");

function galleryInit() {
  var galleryContainer = document.body.querySelector(".works"),
  ...
  leftArrowContainer.insertAdjacentHTML("afterbegin", _icons__WEBPACK_IMPORTED_MODULE_0__["default"].arrowLeft);
  rightArrowContainer.insertAdjacentHTML("afterbegin", _icons__WEBPACK_IMPORTED_MODULE_0__["default"].arrowRigth);
  ...
  function changeImgOnScreen(direction, currentImgSrc) {
    var imgContainer = document.querySelector("[href=\"".concat(currentImgSrc, "\"]")).parentElement;
    ...
    switch (direction) {
      case "right":
        console.log("rrr");
        var nextSiblingImgContainer = imgContainer.nextElementSibling;

        if (!nextSiblingImgContainer) {
          var firstImgContainer = imgContainer.parentElement.firstChild.nextElementSibling;
          var imgHref = firstImgContainer.querySelector("a").getAttribute("href");
          bigImg.setAttribute("src", imgHref);
          imgSrc = imgHref;
          console.log(bigImg, "ttt");
        } else {
          var _imgHref = nextSiblingImgContainer.querySelector("a").getAttribute("href");

          bigImg.setAttribute("src", _imgHref);
          imgSrc = _imgHref;
      ...
      case "left":
        console.log("lll");
        var previousSiblingImgContainer = imgContainer.previousElementSibling;
        ...
        if (!previousSiblingImgContainer) {
          ...
          var lastImgContainer = imgContainer.parentElement.lastChild.previousElementSibling;

          var _imgHref2 = lastImgContainer.querySelector("a").getAttribute("href");

          bigImg.setAttribute("src", _imgHref2);
          imgSrc = _imgHref2;
          console.log(bigImg, "ttt");
        } else {
          var _imgHref3 = previousSiblingImgContainer.querySelector("a").getAttribute("href");

          bigImg.setAttribute("src", _imgHref3);
          imgSrc = _imgHref3;
          console.log(bigImg, "vvv");
        }
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modalsDataStore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modalsDataStore */ "./src/js/modules/modalsDataStore.js");
/* harmony import */ var _clearHelper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./clearHelper */ "./src/js/modules/clearHelper.js");
...
var modals = function modals() {
  function bindModals(triggerClass, modalClass, closeClass) {
    var closeClickOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    var inputFieldsForValidation = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    var engineerBtn = document.body.querySelectorAll(triggerClass),
    ...
    engineerBtn.forEach(function (trigger) {
      trigger.addEventListener("click", function (e) {
        e.preventDefault();

        if (inputFieldsForValidation) {
          var isFilledData = inputFieldsForValidation.every(function (data) {
            return _modalsDataStore__WEBPACK_IMPORTED_MODULE_2__["default"][data];
          });
    ...
    modalCloseEngineer.addEventListener("click", function () {
      modalStyle(modalEngineer, "none");
      _clearHelper__WEBPACK_IMPORTED_MODULE_3__["default"].clearModalsDataStore(_modalsDataStore__WEBPACK_IMPORTED_MODULE_2__["default"]);
    });
  ...
  function closeAllModals(modalsChildren) {
    modalsChildren.forEach(function (modalChild) {
      var modal = modalChild.parentElement;
      modal.style.display = "none";
    });
    document.body.classList.remove("modal-open");
    _clearHelper__WEBPACK_IMPORTED_MODULE_3__["default"].clearDataOnModals();
  }
  ...
  function modalStyle(modal, display) {
    ...
    if (display === "none") {
      ...
      document.body.style.marginRight = "".concat(getScrollWidth(), "px");
    }
  }

  function showModalByTime(modalSelector, time) {
    var modal = document.body.querySelector(modalSelector);
    setTimeout(function () {
  ...
  function initNumberInput() {
    var fieldSelectors = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    fieldSelectors.forEach(function (fieldSelector) {
      var field = document.body.querySelector(fieldSelector);
  ...
  console.log(_modalsDataStore__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
/***/ "./src/js/modules/modalsDataListener.js":
/*!**********************************************!*\
  !*** ./src/js/modules/modalsDataListener.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return changeModalsDataListener; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _modalsDataStore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modalsDataStore */ "./src/js/modules/modalsDataStore.js");
...
function changeModalsDataListener() {
  var balconFormElements = document.body.querySelectorAll(".balcon_icons_img");
  var balconWidthElement = document.body.querySelectorAll(".popup_calc_content #width");
  var balconHeightElement = document.body.querySelectorAll(".popup_calc_content #height");
  var windowTypeElement = document.body.querySelectorAll("#view_type");
  var glazingProfileElements = document.body.querySelectorAll(".popup_calc_profile_content .checkbox");
  ...
  function elemDataChangesHandler(elements, event, prop) {
    elements.forEach(function (elem, index) {
      elem.addEventListener(event, function () {
        switch (event) {
          case "click":
            _modalsDataStore__WEBPACK_IMPORTED_MODULE_1__["default"][prop] = index;
            break;

          case "input":
            _modalsDataStore__WEBPACK_IMPORTED_MODULE_1__["default"][prop] = elem.value;
            break;
          ...
          case "change":
            if (elem.tagName === "SELECT") {
              ...
              console.log(elem);
              elements.forEach(function (checkbox, j) {
                if (index != j) checkbox.checked = false;
              });

              if (!elem.checked) {
                delete _modalsDataStore__WEBPACK_IMPORTED_MODULE_1__["default"][prop];
              } else {
                _modalsDataStore__WEBPACK_IMPORTED_MODULE_1__["default"][prop] = elem.nextElementSibling.getAttribute("id");
              }
            }
        ...
        console.log(_modalsDataStore__WEBPACK_IMPORTED_MODULE_1__["default"]);
      });
    });
  }
...
/***/ "./src/js/modules/modalsDataStore.js":
/*!*******************************************!*\
  !*** ./src/js/modules/modalsDataStore.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (modalsDataStore);

/***/ }),

/***/ "./src/js/modules/saleTimer.js":
/*!*************************************!*\
  !*** ./src/js/modules/saleTimer.js ***!
  \*************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return initSaleTimer; });
/* harmony import */ var core_js_modules_es_object_keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.keys */ "./node_modules/core-js/modules/es.object.keys.js");
/* harmony import */ var core_js_modules_es_object_keys__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_keys__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
...
function initSaleTimer(saleDeadLine, timeContainerClassSelector) {
  function startTimer(timeContainerClass) {
    var timeContainer = document.body.querySelector(timeContainerClass),
    ...
    var intervalId = setInterval(timeDataManager, 1000);
    timeDataManager();

    function timeDataManager() {
      var actualTimeData = getRestTimeData(saleDeadLine);

      if (!actualTimeData) {
        var saleContainer = document.body.querySelector(".sale");
  ...
  function getRestTimeData(deadLine) {
    var timeDifference = Date.parse(deadLine) - Date.parse(new Date());
    ...
    function correctTimeData(timeDataObj) {
      Object.keys(timeDataObj).forEach(function (key) {
        if (timeDataObj[key] < 10) {
          timeDataObj[key] = "0".concat(timeDataObj[key]);
        }
      });
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = (function (tabsSelector, tabsContentSelector) {
  var activeClass = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var displayContent = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "block";
  var tabs = document.body.querySelectorAll(tabsSelector);
  var tabsContent = document.body.querySelectorAll(tabsContentSelector);
  initializeTabs(tabs);
  ...
  function initializeTabs(tabs) {
    ...
    function hideContent() {
      tabsContent.forEach(function (contentOfOneTab) {
